    ...
    ui(new Ui::Report)
{
    ...
    for(int i = 0; i < 8; i++){
        ...
        ui->tableWidget->setItem(i, 0, iStockID);
        ui->tableWidget->setItem(i, 1, lastsinglevalue);
        ui->tableWidget->setItem(i, 2, singlevalue);
        ui->tableWidget->setItem(i, 3, iHolding);
        ui->tableWidget->setItem(i, 4, lastiTotalValue);
        ui->tableWidget->setItem(i, 5, iTotalValue);
        ui->tableWidget->setItem(i, 6, Bep);
        ui->tableWidget->setItem(i, 7, Rate);
    ...
    ui->tableWidget->setItem(8,0,iStockID);
    ui->tableWidget->setItem(8, 3, iHolding);
    ui->tableWidget->setItem(8, 5, iTotalValue);
    ui->tableWidget->setItem(8, 4, lastiTotalValue);
    ui->tableWidget->setItem(8, 6, Bep);
    ui->tableWidget->setItem(8, 7, Rate);

    connect(ui->button, &QPushButton::clicked, this, &QDialog::accept);
}
